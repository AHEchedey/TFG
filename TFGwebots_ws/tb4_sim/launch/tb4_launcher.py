...
def get_ros2_nodes(*args):
    ...
    # 🌟 NUEVO: Nodo controller_manager (ros2_control_node)
    ...
    # Static TF and dummy robot state publisher
    ...
    return [
        ...
        # 🧠 Asegura que controller_manager está lanzado ANTES que los spawners
...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            description='Choose a Webots world file'
        ),
        webots,
        webots._supervisor,
